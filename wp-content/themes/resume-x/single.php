		...
		<div class="<?php echo esc_attr($resume_x_blog_column); ?>">
			<main id="primary" class="site-main">
				...
				while (have_posts()) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'resume-x') . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'resume-x') . '</span> <span class="nav-title">%title</span>',
						)
					);
